      ...
      <div className="mini-container">
        ...
        <div className="results-container">
          <div className="tmb">
            ...
            <IgrExpansionPanel>
              ...
              <h3 slot="subtitle"></h3>
              <span>
                The Golden Retriever is a medium-large gun dog that retrieves
                shot waterfowl, such as ducks and upland game birds, during
                hunting and shooting parties.[3] The name retriever refers to
                the breeds ability to retrieve shot game undamaged due to their
                soft mouth. Golden retrievers have an instinctive love of water,
                and are easy to train to basic or advanced obedience standards.
              </span>
            </IgrExpansionPanel>
          </div>
          ...
          <table className="table-kcals">
            ...
            <tbody>
              ...
              <td>{diet?.calorieDistribution?.dinner ?? "-"}</td> */}
                <td>
                  {typeof diet?.caloriesConsume === "number"
                    ? (diet.caloriesConsume * 0.2).toFixed(0)
                    : "-"}
                </td>
                <td>
                  {typeof diet?.caloriesConsume === "number"
                    ? (diet.caloriesConsume * 0.4).toFixed(0)
                    : "-"}
                </td>
                <td>
                  {typeof diet?.caloriesConsume === "number"
        ...
        <div className="meals-container">
          ...
          <div className="meals-grid">
            <IgrExpansionPanel className="protein-panel">
                    ...
                    {foods
                      ...
                      .map((food, idx) => (
                        <tr key={idx}>
                          ...
                          <td>
                            {Math.round(food.caloriesPer100grams * 0.8)} kcal
                          </td>
                          <td>
                            {Math.round(food.caloriesPer100grams * 0.5)} kcal
                          </td>
            ...
            <IgrExpansionPanel  className="vegetables-panel">
            ...
            <IgrExpansionPanel className="greens-panel">
            ...
            <IgrExpansionPanel className="carbs-panel">
